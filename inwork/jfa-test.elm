...
view model =
    GL.toHtml
        ...
        [ GL.entity vertexShader fragmentShader mesh { mat = ortho2D 1 1 , dims = vec2 winWidth winHeight, time = model.currentTime, mousePos = mouseToVec2 model.mousePos, radius = 60.0 } ]
