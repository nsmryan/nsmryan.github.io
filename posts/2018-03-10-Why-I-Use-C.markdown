...
this blog to provide some insight into my experiences with flight software is
like at NASA.
...
## The Domain The particular domain I am talking about here is embedded systems
...
possible to write very explicit C with enough displine.
